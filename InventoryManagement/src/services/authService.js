...
const AuthService = {
  ...
  getUnfilteredArticles: (params) =>
    axiosInstance.get(`/auth/listUnfilteredArticles`, { params }),
  ...
  bulkImportSubmit: (formData) =>
    axiosInstance.post("/auth/bulkImportExcel", formData),
  ...
  getProductActivities: (productUuid) =>
    axiosInstance.get(`/auth/products/${productUuid}/activities`),
  getAllProductActivities: (productUuid) =>
    axiosInstance.get(`/auth/products/${productUuid}/activities/all`),
  createProductActivity: (productUuid, activityData) =>
    axiosInstance.post(
      `/auth/products/${productUuid}/activities`,
      activityData,
    ),
  ...
  // getStockFlows: (params) =>
  //   axiosInstance.get(`/auth/getStockFlows`, { params }),

  getStockFlowById: (id) => axiosInstance.get(`/auth/getStockFlowByID/${id}`),
  getStockFlowProducts: (id) =>
    axiosInstance.get(`/auth/getStockFlowProducts/${id}`),
  ...
  removeStockProduct: (partial_code) =>
    axiosInstance.put(`/auth/removeStockProduct/${partial_code}`),
  discardDraft: () => axiosInstance.delete("/auth/discardDraft"),
  stockFlowSync: (formData) =>
    axiosInstance.post("/auth/stockFlowSync", formData),

  // stockFlowSubmit:(formData)=>axiosInstance.post('/auth/stockFlowSubmit',formData),

  stockFlowSubmit: (data) => axiosInstance.post("/auth/stockFlowSubmit", data),

  createStockFlow: (formData) =>
    axiosInstance.post(`/auth/createStockFlow`, formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
  ...
  dispatchStockFlow: (id) =>
    axiosInstance.post(`/auth/stockflow/${id}/dispatch`),

  receiveStockFlow: (id, formData) =>
    axiosInstance.post(`/auth/stockflow/${id}/receive`, formData, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    }),
  ...
  getStockRequests: (params) =>
    axiosInstance.get("/auth/getStockRequest", { params }),
  ...
  getStockTransfer: (params) =>
    axiosInstance.get(`/auth/getStockTransfers`, { params }),

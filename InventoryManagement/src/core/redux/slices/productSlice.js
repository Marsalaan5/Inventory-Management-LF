...
// // for add stock flow page
// // export const scanProduct = createAsyncThunk(
// //   "product/scan",
// //   async ({ code,prod_uuid = null }, { rejectWithValue }) => {
// //     try {
       
// //       const params = prod_uuid ? { prod_id: prod_uuid } : {};
// //       const res = await AuthService.getScanForTransfer(code,params); 
// //       return res.data;
// //     } catch (err) {

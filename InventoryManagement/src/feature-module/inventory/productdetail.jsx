...
// import { ArrowLeft, Edit, Save, X, Printer } from 'feather-icons-react/build/IconComponents';
...
//       const binaryPattern = value.split('').map(char =>
...
//       const warehouseOptions = (warehousesRes.data.data || warehousesRes.data || []).map((item) => ({
//         value: item.wh_uuid,
//         label: item.name || item.title,
//       }));

//       const articleProfileOptions = (articleProfilesRes.data.data || articleProfilesRes.data || []).map((item) => ({
...
//     if (formData.status?.value !== 'installed' && !formData.warehouse_id?.value) {
//       MySwal.fire({
//         icon: 'warning',
//         title: 'Error',
...
//         warehouse_id: formData.status?.value !== 'installed'
...
//       await AuthService.updateProductById(currentProduct.prod_uuid, dataToSubmit);
...
//             ) : (
//               <>
//                 <button onClick={handleEditToggle} className="btn btn-cancel" disabled={submitting}>
//                   <X className="me-2" size={16} />
//                   Cancel
//                 </button>
//                 <button onClick={handleSaveChanges} className="btn btn-submit" disabled={submitting}>
//                   {submitting ? (
//                     <>
...
//                   <button className="btn btn-sm btn-secondary mt-2" onClick={handlePrint}>
...
//                         </h6>
//                       ) : (
//                         <h6>{currentProduct.title || 'N/A'}</h6>
//                       )}
//                     </li>
...
//                       <h4>Barcode</h4>
//                       <h6>
//                         <span className="badge badge-secondary">{currentProduct.barcode}</span>
//                       </h6>
//                     </li>

//                     {/* Article Profile */}
//                     <li>
//                       <h4>Article Profile <span className="text-danger">*</span></h4>
//                       {isEditing ? (
//                         <h6>
//                           <Select
...
//                         </h6>
//                       ) : (
//                         <h6>{currentProduct.article_profile_name || 'N/A'}</h6>
//                       )}
//                     </li>
...
//                       <h4>
//                         Warehouse
//                         {formData.status?.value !== 'installed' && isEditing && <span className="text-danger">*</span>}
//                       </h4>
//                       {isEditing ? (
//                         <h6>
//                           <Select
...
//                             isDisabled={formData.status?.value === 'installed'}
//                             className="select"
//                           />
//                           {formData.status?.value === 'installed' && (
//                             <small className="text-muted d-block mt-1">Not required for installed items</small>
//                           )}
//                         </h6>
//                       ) : (
//                         <h6>{currentProduct.warehouse_name || 'N/A'}</h6>
//                       )}
//                     </li>
...
//                             required={formData.status?.value === 'installed'}
//                           />
//                           {formData.status?.value === 'installed' && (
//                             <small className="text-muted d-block mt-1">Required for installed items</small>
//                           )}
//                         </h6>
//                       ) : (
//                         <h6>{currentProduct.location || 'N/A'}</h6>
//                       )}
//                     </li>

//                     {/* In WH Location */}
//                     <li>
//                       <h4>In WH Location</h4>
//                       {isEditing ? (
//                         <h6>
//                           <input
//                             type="text"
...
//                         </h6>
//                       ) : (
//                         <h6>{currentProduct.in_wh_locn || 'N/A'}</h6>
//                       )}
//                     </li>
...
//                       ) : (
//                         <h6>
//                           <span className="badge badge-primary">{currentProduct.count || 0}</span>
//                         </h6>
//                       )}
//                     </li>
...
//                       ) : (
//                         <h6>
//                           <span className={`badge ${getStatusBadgeClass(currentProduct.status)}`}>
...
//                             maxLength="500"
//                           />
//                           <small className="text-muted d-block mt-1">Maximum 500 characters</small>
//                         </h6>
//                       ) : (
...
//                     <li>
//                       <h4>Created At</h4>
//                       <h6>{new Date(currentProduct.created_at).toLocaleString()}</h6>
//                     </li>

//                     {/* Last Updated */}
//                     <li>
//                       <h4>Last Updated</h4>
//                       <h6>{new Date(currentProduct.updated_at).toLocaleString()}</h6>
//                     </li>
//                   </ul>
//                 </div>
//               </div>
...
//             <div className="card">
//               <div className="card-body">
//                 <h5 className="card-title mb-3">Quick Information</h5>

//                 <div className="mb-3">
//                   <small className="text-muted">Product UUID</small>
...
//                   <div className="mb-3">
//                     <small className="text-muted">Article Profile ID</small>
//                     <p className="mb-0 font-monospace small text-break">
//                       {currentProduct.article_profile_id}
//                     </p>
//                   </div>
...
//                   <div className="mb-3">
//                     <small className="text-muted">Warehouse ID</small>
//                     <p className="mb-0 font-monospace small text-break">
//                       {currentProduct.warehouse_id}
//                     </p>
//                   </div>

...
// const deriveActions = (status) => ({
//   can_dispatch: status === "approved",
//   can_receive:  status === "in-transit",
...
//for camera
 ...
 //edit form
  ...
  //  Table columns
  //
  //  API record shape (key fields):
  //    stock_id         — string PK, e.g. "STT-GNW-02526-5"
  //    requester_wh     — "From" warehouse name
  //    dispatcher_wh    — "To" warehouse name  (sender's warehouse)
  //    requester_name   — person who requested
  //    dispatcher_name  — person who dispatched
  //    transport        — "bus" | "courier" | "employee"
  //    status           — "approved" | "in-transit" | "delivered"
  //    ack_status       — "pending" | "acknowledged"
  //    product_arr      — [{ prod_uuid, partial_code, article_profile_name,
  //                          status, count }]
  //    total_products   — number of distinct product lines
  //    stock_req_id     — linked request ID
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        // const actions = deriveActions(record.status);
            ...
            <div className="table-top">
              <div className="search-set">
                <div className="search-input">
                  <input
                    type="text"
                    placeholder="Search by description, SKU or warehouse"

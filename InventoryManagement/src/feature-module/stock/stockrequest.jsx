...
const StockRequest = () => {
  ...
  const pagination = activeBucket.pagination || {
    currentPage: 1,
    totalPages: 1,
    total: 0,
  };
  ...
  const columns = [
    {
      ...
      render: (_, record) => (
        ...
        >
          <i
            className={`${record.is_starred ? "fas text-warning" : "far text-muted"} fa-star`}
          />
        </span>
      ),
    },
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        return (
          <span
            className={`badge ${derived.badge} d-inline-flex align-items-center gap-1`}
          >
            {derived.icon}
            {derived.label}
          </span>
  ...
  const statCards = [
    {
      ...
      value: reduxStats.total || 0,
      cls: "das5",
      icon: <Package />,
    },
    {
      label: "Pending",
      value: reduxStats.pending || 0,
      cls: "das6",
      icon: <Clock />,
    },
    {
      label: "Approved",
      value: reduxStats.approved || 0,
      cls: "das7",
      icon: <ThumbsUp />,
    },
    {
      label: "Delivered",
      value: reduxStats.received || 0,
      cls: "das8",
      icon: <CheckCircle />,
    },
  ];
              ...
              <div className="search-set">
                <div className="search-input">
                  <input
                    ...
                    onChange={(e) =>
                      dispatch(
                        setReqFilters({ search: e.target.value, page: 1 }),
                      )
                    }
                  />
